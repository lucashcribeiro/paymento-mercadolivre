...
It is possible to filter the news feed down to just users you follow, or a single user.',
  ...
  'option_group_description.xfa_nit' => 'Configuration of the Nodes Icon Tweak add-on from Xen Factory',
  'option_group_description.xs_uup_settings' => 'Options here control the User Upgrade Pro add-on by Xen-Soluce.',
);