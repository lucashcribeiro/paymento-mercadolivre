<?php
// FROM HASH: 96ad9faca216421a1ca6a4f65668e1fc
return array(
		...
		$__compilerTemp1 .= '
				' . $__templater->formInfoRow('
					<p class="block-rowMessage block-rowMessage--warning block-rowMessage--iconic">
						...
						' . 'Deleting this shipping method will also reset <b>' . $__templater->filter($__vars['numOrders'], array(array('number', array()),), true) . '</b> order items using this shipping method to "Unselected". This action cannot be undone. Please tick the box below to confirm you really wish to do this.' . '
					</p>
					<p>
