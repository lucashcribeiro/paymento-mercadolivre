...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		'name' => 'xs_uup_enable_invoice',
		'selected' => $__vars['field']['xs_uup_enable_invoice'],
		'label' => 'Enable field on the invoice',
		'hint' => 'If this option is enabled, the information entered will be added on the invoice.',
		'_type' => 'option',
	)), array(
	)) . '
	');
