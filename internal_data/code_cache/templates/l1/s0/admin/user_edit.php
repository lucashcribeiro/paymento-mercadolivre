...
' . $__templater->formCheckBoxRow(array(
		...
		'name' => 'xs_uup_alert_expired',
		'selected' => $__vars['user']['xs_uup_alert_expired'],
		'hint' => 'If this option is enabled the user will receive an alert according to the settings set in the options <a href="admin.php?options/groups/xs_uup_settings" target="_bank">here</a>.',
