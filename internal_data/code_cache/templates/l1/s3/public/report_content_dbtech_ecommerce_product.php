<?php
// FROM HASH: c7dc50fe4d04004465b4be2f6d84abdc
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '<div class="block-row block-row--separated">
	' . $__templater->func('bb_code', array($__vars['report']['content_info']['product']['description'], 'dbtech_ecommerce_product', ($__vars['content'] ?: $__vars['report']['User']), ), true) . '
</div>
