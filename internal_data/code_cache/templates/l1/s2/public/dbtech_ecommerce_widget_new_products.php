<?php
// FROM HASH: 084ebd28e1b536cdfd2982560bc1d378
return array(
		...
		if ($__vars['style'] == 'full') {
			$__finalCompiled .= '
				<h3 class="block-header">
					<a href="' . $__templater->escape($__vars['link']) . '" rel="nofollow">' . ($__templater->escape($__vars['title']) ?: 'Latest eCommerce products') . '</a>
				</h3>
