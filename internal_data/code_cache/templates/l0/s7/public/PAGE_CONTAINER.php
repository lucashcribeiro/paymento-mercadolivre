<?php
// FROM HASH: dc430584b198e200b9011109ad02723b
return array(
...
' . $__templater->includeTemplate('xs_uup_button_popup', $__vars) . '
';
		}
		...
		<div uix_component="MainSidebar" class="p-body-sidebar">
			...
			<div class="uix_sidebarInner ' . (($__templater->func('property', array('uix_stickySidebar', ), false) == 'top') ? ' uix_stickyBodyElement' : '') . '">
				<div class="uix_sidebar--scroller">
					...
					' . '
					';
		if ($__templater->func('property', array('gift_enableGiftWelcome', ), false)) {
			$__compilerTemp16 .= '
						';
			$__vars['gift_welcomeText'] = array($__templater->func('property', array('gift_welcomeText1', ), false), $__templater->func('property', array('gift_welcomeText2', ), false), $__templater->func('property', array('gift_welcomeText3', ), false), $__templater->func('property', array('gift_welcomeText4', ), false), $__templater->func('property', array('gift_welcomeText5', ), false), );
			$__compilerTemp16 .= '
						';
			$__vars['gift_welcomeLink'] = array($__templater->func('property', array('gift_welcomeLink1', ), false), $__templater->func('property', array('gift_welcomeLink2', ), false), $__templater->func('property', array('gift_welcomeLink3', ), false), $__templater->func('property', array('gift_welcomeLink4', ), false), $__templater->func('property', array('gift_welcomeLink5', ), false), );
			$__compilerTemp16 .= '
						';
			$__vars['i'] = 0;
			if ($__templater->isTraversable($__vars['gift_welcomeText'])) {
				foreach ($__vars['gift_welcomeText'] AS $__vars['key'] => $__vars['gift_text']) {
					$__vars['i']++;
					$__compilerTemp16 .= '
							';
					if ($__vars['gift_text']) {
						$__compilerTemp16 .= '
								';
						$__vars['gift_topTextIndex'] = $__vars['i'];
						$__compilerTemp16 .= '
							';
					}
					$__compilerTemp16 .= '
			...
			$__compilerTemp16 .= '
						';
			$__vars['gift_welcomeTextIndex'] = ($__templater->func('rand', array(1, $__vars['gift_topTextIndex'], ), false) - 1);
			$__compilerTemp16 .= '
						<div class="block">
							<div class="gift_giftSuggestion">
								<div class="gift_giftSuggestion--text">
									<span class="gift_giftSuggestion--header">' . $__templater->func('property', array('gift_welcomeHeading', ), true) . ' </span>' . $__templater->escape($__vars['gift_welcomeText'][$__vars['gift_welcomeTextIndex']]) . '
								</div>
								';
			if ($__vars['gift_welcomeLink'][$__vars['gift_welcomeTextIndex']]) {
				$__compilerTemp16 .= $__templater->button($__templater->func('property', array('gift_welcomeButtonText', ), true), array(
					'href' => $__vars['gift_welcomeLink'][$__vars['gift_welcomeTextIndex']],
					'class' => 'button--cta',
				), '', array(
				));
			}
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__compilerTemp31 .= '
					<ul class="uix_sidebarNavList">
						<li><div class="p-navEl ' . (($__vars['uix_myAccountLinks'] == 'profile') ? 'is-selected' : '') . '"><div class="p-navEl__inner u-ripple"><a data-nav-id="profile" href="' . $__templater->func('link', array('members', $__vars['xf']['visitor'], ), true) . '" class="p-navEl-link">' . 'Profile' . '</a></div></div></li>
						<li><div class="p-navEl ' . (($__vars['uix_myAccountLinks'] == 'alerts') ? 'is-selected' : '') . '"><div class="p-navEl__inner u-ripple"><a data-nav-id="alerts" href="' . $__templater->func('link', array('account/alerts', ), true) . '" class="p-navEl-link">' . 'Alerts' . '</a></div></div></li>
						<li><div class="p-navEl ' . (($__vars['uix_myAccountLinks'] == 'settings') ? 'is-selected' : '') . '"><div class="p-navEl__inner u-ripple"><a data-nav-id="settings" href="' . $__templater->func('link', array('account/preferences', ), true) . '" class="p-navEl-link">' . 'Settings' . '</a></div></div></li>
					</ul>
				';
	}
	$__compilerTemp32 = '';
...
<html id="XF" lang="' . $__templater->escape($__vars['xf']['language']['language_code']) . '" dir="' . $__templater->escape($__vars['xf']['language']['text_direction']) . '"
	...
	if (!$__vars['uix_hideNavigation']) {
		...
		$__compilerTemp59 .= '
									<a class="p-nav-menuTrigger ' . (($__vars['uix_visitorTabsMobile'] == 'canvas') ? 'js-badge--alerts js-badge--conversations' : '') . ' badgeContainer' . (($__vars['uix_visitorTabCanvas'] AND ($__vars['xf']['visitor']['alerts_unread'] OR $__vars['xf']['visitor']['conversations_unread'])) ? ' badgeContainer--highlighted' : '') . '" data-badge="' . $__templater->filter($__vars['uix_badgeCounter'], array(array('number', array()),), true) . '" data-xf-click="off-canvas" data-menu=".js-headerOffCanvasMenu" role="button" tabindex="0">
										<i aria-hidden="true"></i>
