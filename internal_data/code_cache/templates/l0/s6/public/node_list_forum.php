<?php
// FROM HASH: 0788b17ad346f71ae2f3c31f28bb7eb4
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	<li>
		<a href="' . $__templater->func('link', array('forums', $__vars['node'], ), true) . '" class="subNodeLink subNodeLink--forum node--id' . $__templater->escape($__vars['node']['node_id']) . ' ' . ($__vars['extras']['hasNew'] ? 'subNodeLink--unread' : '') . '">
			' . $__templater->includeTemplate('xfa_nit_node_list_small', $__vars) . $__templater->escape($__vars['node']['title']) . '
		</a>
