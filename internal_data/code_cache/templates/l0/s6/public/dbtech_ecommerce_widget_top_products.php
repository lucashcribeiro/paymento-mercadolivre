<?php
// FROM HASH: 59584f3eacb4f3b36d2cd1fe76a7505b
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="block"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
		...
		if ($__vars['style'] == 'full') {
			$__finalCompiled .= '
				<h3 class="block-header">' . ($__templater->escape($__vars['title']) ?: 'Top rated products') . '</h3>
			...
			$__finalCompiled .= '
				<h3 class="block-minorHeader">' . ($__templater->escape($__vars['title']) ?: 'Top rated products') . '</h3>
				<ul class="block-body">
					';
			if ($__templater->isTraversable($__vars['products'])) {
				foreach ($__vars['products'] AS $__vars['product']) {
