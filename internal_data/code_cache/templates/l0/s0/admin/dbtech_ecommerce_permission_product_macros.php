<?php
// FROM HASH: 824142d29595c56876f354729912788b
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->form('
		...
		'hint' => 'If selected, users will only be able to view this product if they are explicitly granted permissions.',
		'_type' => 'option',
	)), array(
	)) . '
			</div>
	...
	', array(
		'action' => $__templater->func('link', array($__vars['routeBase'] . '/save', $__vars['product'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	)) . '
	...
	if ($__templater->isTraversable($__vars['userGroups'])) {
		foreach ($__vars['userGroups'] AS $__vars['userGroup']) {
			$__compilerTemp1 .= '
				...
				'href' => $__templater->func('link', array($__vars['routeBase'] . '/edit', $__vars['product'], array('user_group_id' => $__vars['userGroup']['user_group_id'], ), ), false),
		...
		if ($__templater->isTraversable($__vars['users'])) {
			foreach ($__vars['users'] AS $__vars['user']) {
				$__compilerTemp3 .= '
					...
					'href' => $__templater->func('link', array($__vars['routeBase'] . '/edit', $__vars['product'], array('user_id' => $__vars['user']['user_id'], ), ), false),
	...
	', array(
		'action' => $__templater->func('link', array($__vars['routeBase'] . '/edit', $__vars['product'], ), false),
		'class' => 'block',
	)) . '
';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	', array(
		'action' => $__templater->func('link', array($__vars['routeBase'] . '/save', $__vars['product'], $__vars['saveParams'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	)) . '
';
