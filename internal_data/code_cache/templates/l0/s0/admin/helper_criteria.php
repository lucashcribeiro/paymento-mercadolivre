...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		'name' => 'user_criteria[XsUserUpgradeExpired][rule]',
		'value' => 'XsUserUpgradeExpired',
		'selected' => $__vars['criteria']['XsUserUpgradeExpired'],
		'label' => 'One / more of these subscriptions are over',
		'_type' => 'option',
	)), array(
		'label' => 'Privileges and status',
	)) . '
' . $__templater->includeTemplate('xs_uup_helper_criteria', $__vars) . '
