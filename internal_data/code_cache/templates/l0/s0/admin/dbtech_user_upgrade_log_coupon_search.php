<?php
// FROM HASH: fffbe4a2da64b1086af6f5ab62d93fbd
return array(
...
';
	...
	$__compilerTemp2 = $__templater->mergeChoiceOptions($__compilerTemp2, $__vars['userUpgrades']);
	...
	<div class="block-container">
		...
		'label' => 'Coupon',
			...
			' . $__templater->formSelectRow(array(
		'name' => 'criteria[user_upgrade_id]',
		'value' => $__vars['criteria']['user_upgrade_id'],
...
', array(
		'action' => $__templater->func('link', array('dbtech-upgrades/logs/coupons', ), false),
		'class' => 'block',
	));
