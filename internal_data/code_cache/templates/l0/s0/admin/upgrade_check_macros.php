...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->method($__vars['upgradeCheck'], 'hasLicenseErrors', array())) {
		...
		if ($__vars['upgradeCheck']['license_expired']) {
			$__compilerTemp1 .= '
						<li>' . 'Your license has now expired. You will not have access to new versions or support. To continue to get the latest updates and receive support, you should renew now.' . '</li>
					';
		}
		$__compilerTemp1 .= '
				';
