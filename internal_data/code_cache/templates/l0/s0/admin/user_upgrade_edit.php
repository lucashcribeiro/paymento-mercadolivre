...
' . $__templater->formNumberBoxRow(array(
		'name' => 'xs_uup_renew_day',
		'value' => $__vars['upgrade']['xs_uup_renew_day'],
	), array(
		'label' => 'Renewal day',
		'explain' => 'Set the number of days before the expiration date the user will be able to renew his subscription.',
	)) . '
' . $__templater->formNumberBoxRow(array(
		'name' => 'xs_uup_alert_time_active',
		'value' => $__vars['upgrade']['xs_uup_alert_time_active'],
	), array(
		'label' => 'User alert (before expiration)',
		'explain' => 'This option allows you to send an email and/or start a conversation before the expiration of this upgrade, enter the number of days to notify the user before the expiration date (enter 0 to disable this option).',
	)) . '
' . $__templater->formNumberBoxRow(array(
		'name' => 'xs_uup_alert_time_expired',
		'value' => $__vars['upgrade']['xs_uup_alert_time_expired'],
	), array(
		'label' => 'User alert (after expiration)',
		'explain' => 'This option allows you to send an email and/or start a conversation after the expiration of this upgrade, enter the number of days to notify the user after the expiration date (enter 0 to disable this option).',
	)) . '
' . $__templater->formCheckBoxRow(array(
	), array(array(
		'name' => 'xs_uup_invoice_active',
		'selected' => $__vars['upgrade']['xs_uup_invoice_active'],
		'label' => 'Exclude from invoicing',
		'_type' => 'option',
	)), array(
		'explain' => 'This option allows you to exclude this upgrade from invoicing.',
	)) . '
' . $__templater->formCheckBoxRow(array(
	), array(array(
		'name' => 'xs_uup_alert_admin',
		'selected' => $__vars['upgrade']['xs_uup_alert_admin'],
		'label' => 'Send an alert to the admin',
		'_type' => 'option',
	)), array(
		'explain' => 'If this option is enabled it will send an alert according to the settings in the options <a href="admin.php?options/groups/xs_uup_settings" target="_bank">here</a>.',
	)) . '
		</div>
