<?php
// FROM HASH: 82c74f35f1d9a70df75f96fc2a05da01
return array(
		...
		$__compilerTemp1 .= '
				' . $__templater->formInfoRow('
					<p class="block-rowMessage block-rowMessage--warning block-rowMessage--iconic">
						...
						' . 'Deleting this shipping zone will also reset <b>' . $__templater->filter($__vars['numOrders'], array(array('number', array()),), true) . '</b> order items using this shipping zone to "Unselected". This action cannot be undone. Please tick the box below to confirm you really wish to do this.' . '
					</p>
					<p>
