<?php
// FROM HASH: b97f4a756c08b1cf330f8b7df7cd2ecf
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Reassign products');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Are you sure you want to reassign ' . $__templater->escape($__vars['total']) . ' product(s)?', array(
		'rowtype' => 'confirm',
	)) . '
