...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	<li>
		<a href="' . $__templater->func('link', array('pages', $__vars['node'], ), true) . '" class="subNodeLink subNodeLink--page node--id' . $__templater->escape($__vars['node']['node_id']) . '">' . $__templater->includeTemplate('xfa_nit_node_list_small', $__vars) . $__templater->escape($__vars['node']['title']) . '</a>
