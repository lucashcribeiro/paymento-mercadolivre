 ...
 */
class RandomProducts extends AbstractWidget
{
	/** @var array */
	...
	public function render()
	{
		...
		$finder = $productRepo->findRandomProducts($sourceCategoryIds);
		...
		$link = $router->buildLink('dbtech-ecommerce');
		...
		return $this->renderer('dbtech_ecommerce_widget_random_products', $viewParams);
	}
