...
class NewProducts extends AbstractWidget
{
	...
	public function render()
	{
		...
		$finder = $productRepo->findNewProducts($sourceCategoryIds);
		...
		$link = $router->buildLink('whats-new/ecommerce-products', null, ['skip' => 1]);
		...
		return $this->renderer('dbtech_ecommerce_widget_new_products', $viewParams);
	}
